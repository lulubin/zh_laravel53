                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/setting') }}">
                        ...
                        <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="city" type="text" class="form-control" name="city" value="{{user()->setting['city']}}" required autofocus>
                                @if ($errors->has('city'))
                        ...
                        <div class="form-group{{ $errors->has('bio') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="bio" id="bio" class="form-control">{{user()->setting['bio']}}</textarea>
                                @if ($errors->has('bio'))
                                <span class="help-block">
